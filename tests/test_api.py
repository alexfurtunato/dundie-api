...
def test_user_list(
    api_client,
    api_client_create_user1,  # pyright: ignore
    api_client_create_user2,  # pyright: ignore
    api_client_create_user3,  # pyright: ignore
):
...
def test_fail_update_user_profile_by_other_user(api_client_user2):
    ...
    data = {"avatar": "https://example.com/avatar.png", "bio": "I am a user1"}
    response = api_client_user2.patch("/user/user1/", json=data)
